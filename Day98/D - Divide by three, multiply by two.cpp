...
Approach :- we store frequency of each element in array , we run a loop on array and for each element we try to find all the values which are preset in array
